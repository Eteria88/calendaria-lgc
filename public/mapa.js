...
(function(){
  ...
  function setHashN3(n3){
    try{ history.replaceState(null, "", `#n3=${String(n3).padStart(3,"0")}`); }catch(e){ location.hash = `n3=${String(n3).padStart(3,"0")}`; }
  }
  function getHashN3(){
    const m = (location.hash||"").match(/n3=(\d{1,3})/);
