(function(){
  ...
  try{
    ...
    function up(){
      ...
      el=$('#lifeDays'); if(el) el.textContent = (dob ? (function(){ var tUTC = Date.UTC(Rf.y, Rf.m-1, Rf.d); var dobUTC=Date.UTC(Db.y,Db.m-1,Db.d); return Math.floor((tUTC-dobUTC)/ms); })() : '0');
